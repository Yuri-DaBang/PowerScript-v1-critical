...
@dataclass
class CondNode(ControlFlowNode):
    orelse: Optional[
        Union[
            BlockNode,
            'CondNode',
...
@dataclass
class VoidFunctionDefinitionNode(CodeUnitNode):
    params: ItemizedExpressionNode = field(kw_only=True)
...
@dataclass
class VoidMemberFunctionDefinitionNode(FunctionDefinitionNode):
    struct: IdentifierNode = field(kw_only=True)
...
@dataclass
class ExtensionDefinitionNode(CodeUnitNode):
    parents: Optional[ItemizedExpressionNode] = field(kw_only=True)
